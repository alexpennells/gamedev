...
var GameManager = {
	...
	createObjects: function () {
		...
		this.objects.push(new Paddle(this.borderSize, this.borderSize, eKeys.W, eKeys.S));

		// Create the right paddle. (Note that paddle width = 20)
		this.objects.push(new Paddle(this.canvas.width - this.borderSize - 20, this.borderSize, eKeys.UP, eKeys.DOWN));
	},
